...
def main(data_path, dollarstoinv, USreserve, USDwealth, min_gain, qlearn, alpha):
    ...
    global random, pd, np, Q, balance, open_positions, datetime_table, max_EURUSD, max_GBPUSD, max_AUDUSD, min_EURUSD, min_AUDUSD, min_GBPUSD, EURUSD_hist, AUDUSD_hist, GBPUSD_hist, state_action_hist, price, units
    ...
    for index, row in forex_toy.iterrows():
        ...
        if index%200 == 0:
            balance.to_csv(r'U:/Users/dcaramu/Desktop/Machine Learning Nano/9 capstone_project/codigo/balance_nolearn.txt', header=True, index=True, sep=' ')
    ...
    table_file = open('U:/Users/dcaramu/Desktop/Machine Learning Nano/9 capstone_project/codigo/Q.txt', 'w') #usar wb si no funciona w
    f = table_file
    f.write("/-----------------------------------------\n")
